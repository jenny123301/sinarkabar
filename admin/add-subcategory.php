...
if (strlen($_SESSION['login']) == 0) {
    ...
    <head>
        ...
        <title>Sinar Kabar | Tambah Subkategori</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tambah Subkategori</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Tambah Subkategori</b></h4>
                                    <hr />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="category" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Subkategori</label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Deskripsi Subkategori</label>
                                                    <div class="col-md-10">
