...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            echo "<script>alert('Penulis details added successfully.');</script>";
    ...
    <head>
        ...
        <title>Sinar Kabar | Tambah Penulis</title>
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tambah Penulis</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Tambah Penulis</b></h4>
                                    <hr />
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="addsuadmin" method="post">
                                                <div class="form-group">
                                                    <label for="exampleInputusername">Nama Penulis</label>
