...
if (strlen($_SESSION['login']) == 0) {
    ...
    <head>
        ...
        <!-- App title -->
        <title>Sinar Kabar | Kelola Artikel</title>
                                                            ...
                                                            while ($row = mysqli_fetch_array($query)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        &nbsp;<a href="manage-posts.php?pid=<?php echo htmlentities($row['postid']); ?>&&action=del" onclick="return confirm('Do you really want to delete ?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> 
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                        $cnt++; // Perbarui nomor setiap kali loop dijalankan
                                                    }
                                                }
                                                ?>
