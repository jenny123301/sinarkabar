...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            echo "<script>alert('Penulis details updated.');</script>";
        } else {
    ...
    <head>
        ...
        <title>Sinar Kabar | Update Penulis</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Penulis</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edit Penulis </b></h4>
                                    <hr />
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal" name="suadmin" method="post">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">Nama Penulis</label>
                                                        <div class="col-md-10">
